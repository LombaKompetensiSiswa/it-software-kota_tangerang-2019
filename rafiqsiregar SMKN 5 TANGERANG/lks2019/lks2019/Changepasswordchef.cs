...
namespace lks2019
{
    public partial class Changepasswordchef : Form
    {
        public Changepasswordchef()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                db.SubmitChanges();
                dataGridView1.DataSource = db.Msemployees.Where(s => s.Position == "Chef");
        ...
        private void Changepasswordchef_Load(object sender, EventArgs e)
        {
            tampil();
        }
