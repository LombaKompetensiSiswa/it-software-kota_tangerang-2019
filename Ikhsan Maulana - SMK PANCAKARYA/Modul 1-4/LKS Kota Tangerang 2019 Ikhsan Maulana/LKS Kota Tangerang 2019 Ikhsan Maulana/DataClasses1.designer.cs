...
namespace LKS_Kota_Tangerang_2019_Ikhsan_Maulana
{
    ...
    partial void InsertDetailPackage(DetailPackage instance);
    partial void UpdateDetailPackage(DetailPackage instance);
    partial void DeleteDetailPackage(DetailPackage instance);
    ...
    partial void InsertHeaderPackage(HeaderPackage instance);
    partial void UpdateHeaderPackage(HeaderPackage instance);
    partial void DeleteHeaderPackage(HeaderPackage instance);
    ...
    partial void DeleteMsmenu(Msmenu instance);
		...
		public System.Data.Linq.Table<DetailPackage> DetailPackages
		{
			get
			{
				return this.GetTable<DetailPackage>();
			}
		}
		...
		public System.Data.Linq.Table<HeaderPackage> HeaderPackages
		{
			get
			{
				return this.GetTable<HeaderPackage>();
			}
		}
    ...
    partial void OnDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Headerorder_Review", Storage="_Headerorder", ThisKey="Orderid", OtherKey="OrderID", IsForeignKey=true)]
		public Headerorder Headerorder
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DetailPackage")]
	public partial class DetailPackage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _DetailPackageID;
		
		private int _HeaderPackageID;
		
		private int _Menuid;
		
		private int _Qty;
		
		private EntityRef<HeaderPackage> _HeaderPackage;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnDetailPackageIDChanging(int value);
    partial void OnDetailPackageIDChanged();
    partial void OnHeaderPackageIDChanging(int value);
    partial void OnHeaderPackageIDChanged();
    partial void OnMenuidChanging(int value);
    partial void OnMenuidChanged();
    partial void OnQtyChanging(int value);
    partial void OnQtyChanged();
		...
		{
			this._HeaderPackage = default(EntityRef<HeaderPackage>);
			this._Msmenu = default(EntityRef<Msmenu>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DetailPackageID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int DetailPackageID
		{
			get
			{
				return this._DetailPackageID;
			}
			set
			{
				if ((this._DetailPackageID != value))
				{
					this.OnDetailPackageIDChanging(value);
					this.SendPropertyChanging();
					this._DetailPackageID = value;
					this.SendPropertyChanged("DetailPackageID");
					this.OnDetailPackageIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HeaderPackageID", DbType="Int NOT NULL")]
		public int HeaderPackageID
		{
			get
			{
				return this._HeaderPackageID;
			}
			set
			{
				if ((this._HeaderPackageID != value))
				{
					if (this._HeaderPackage.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnHeaderPackageIDChanging(value);
					this.SendPropertyChanging();
					this._HeaderPackageID = value;
					this.SendPropertyChanged("HeaderPackageID");
					this.OnHeaderPackageIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HeaderPackage_DetailPackage", Storage="_HeaderPackage", ThisKey="HeaderPackageID", OtherKey="HeaderPackageID", IsForeignKey=true)]
		public HeaderPackage HeaderPackage
		{
			get
			{
				return this._HeaderPackage.Entity;
			}
			set
			{
				HeaderPackage previousValue = this._HeaderPackage.Entity;
				if (((previousValue != value) 
							|| (this._HeaderPackage.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._HeaderPackage.Entity = null;
						previousValue.DetailPackages.Remove(this);
					}
					this._HeaderPackage.Entity = value;
					if ((value != null))
					{
						value.DetailPackages.Add(this);
						this._HeaderPackageID = value.HeaderPackageID;
					}
					else
					{
						this._HeaderPackageID = default(int);
					}
					this.SendPropertyChanged("HeaderPackage");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Msmenu_DetailPackage", Storage="_Msmenu", ThisKey="Menuid", OtherKey="MenuID", IsForeignKey=true)]
		public Msmenu Msmenu
		{
			get
			{
    ...
    partial void OnCardNumberChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Headerorder_Review", Storage="_Reviews", ThisKey="OrderID", OtherKey="Orderid")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HeaderPackage")]
	public partial class HeaderPackage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _CountMeat;
		
		private int _CountVegetables;
		
		private int _Price;
		
		private int _MinOrder;
		
		private EntitySet<DetailPackage> _DetailPackages;
    ...
    partial void OnCountMeatChanging(int value);
    partial void OnCountMeatChanged();
    partial void OnCountVegetablesChanging(int value);
    partial void OnCountVegetablesChanged();
    partial void OnPriceChanging(int value);
    partial void OnPriceChanged();
    partial void OnMinOrderChanging(int value);
    partial void OnMinOrderChanged();
    #endregion
		
		public HeaderPackage()
		{
			this._DetailPackages = new EntitySet<DetailPackage>(new Action<DetailPackage>(this.attach_DetailPackages), new Action<DetailPackage>(this.detach_DetailPackages));
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HeaderPackageID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int HeaderPackageID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CountMeat", DbType="Int NOT NULL")]
		public int CountMeat
		{
			get
			{
				return this._CountMeat;
			}
			set
			{
				if ((this._CountMeat != value))
				{
					this.OnCountMeatChanging(value);
					this.SendPropertyChanging();
					this._CountMeat = value;
					this.SendPropertyChanged("CountMeat");
					this.OnCountMeatChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CountVegetables", DbType="Int NOT NULL")]
		public int CountVegetables
		{
			get
			{
				return this._CountVegetables;
			}
			set
			{
				if ((this._CountVegetables != value))
				{
					this.OnCountVegetablesChanging(value);
					this.SendPropertyChanging();
					this._CountVegetables = value;
					this.SendPropertyChanged("CountVegetables");
					this.OnCountVegetablesChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MinOrder", DbType="Int NOT NULL")]
		public int MinOrder
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HeaderPackage_DetailPackage", Storage="_DetailPackages", ThisKey="HeaderPackageID", OtherKey="HeaderPackageID")]
		public EntitySet<DetailPackage> DetailPackages
		{
			get
			{
				return this._DetailPackages;
			}
			set
			{
				this._DetailPackages.Assign(value);
			}
		}
		...
		private void attach_DetailPackages(DetailPackage entity)
		{
			this.SendPropertyChanging();
			entity.HeaderPackage = this;
		}
		
		private void detach_DetailPackages(DetailPackage entity)
		{
			this.SendPropertyChanging();
			entity.HeaderPackage = null;
		}
	}
    ...
    partial void OnCategoryChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Msmenu_DetailPackage", Storage="_DetailPackages", ThisKey="MenuID", OtherKey="Menuid")]
		public EntitySet<DetailPackage> DetailPackages
		{
			get
			{
